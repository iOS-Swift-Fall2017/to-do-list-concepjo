...
//  To Do List
//
//  Created by Joshua Concepcion on 9/25/17.
...
//    var toDoNotesArray = ["I should be certain to do all of the exercises at the end of the chapters before the exam." , "Take my ideas to the schoo;s venture competition and win the big check." , "focus apps on empowerment for all, with an extra bonus for users who are kind."]
